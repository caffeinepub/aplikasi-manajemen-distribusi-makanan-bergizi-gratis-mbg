...
import { ArrowRight, Package, TrendingUp, Truck, Users } from "lucide-react";
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <img
                src="/assets/generated/food-distribution.dim_600x400.jpg"
                alt="Distribusi"
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Sistem ini membantu mengelola dan memantau distribusi makanan
              bergizi gratis kepada penerima manfaat B3 di Kecamatan Cisalak.
              Dengan sistem yang terstruktur, proses distribusi menjadi lebih
              efisien dan terdata dengan baik.
            </p>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <img
                src="/assets/generated/official-document.dim_400x300.jpg"
                alt="Laporan"
                className="h-8 w-8 rounded object-cover"
              />
              Menu Cepat
