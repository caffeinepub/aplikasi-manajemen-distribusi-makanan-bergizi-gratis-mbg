    ...
    tambahPaket(
      ...
      },
      {
        onSuccess: () => {
          ...
          setFormData({ nama: '', jenis: 'paketSembako', jenisLainnya: '', keterangan: '' });
        },
      }
    );
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold text-emerald-900">Data Paket MBG</h2>
          <p className="text-muted-foreground">Kelola informasi paket makanan bergizi gratis</p>
        </div>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="makananSiapSaji">Makanan Siap Saji</SelectItem>
              ...
              {formData.jenis === 'lainnya' && (
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({ ...formData, jenisLainnya: e.target.value })}
                    required
                    disabled={isAdding}
        ...
        <CardContent>
          ...
          {isLoading ? (
            ...
            <div className="py-8 text-center text-muted-foreground">
              {searchTerm ? 'Tidak ada data yang sesuai dengan pencarian' : 'Belum ada data paket'}
            </div>
          ) : (
                ...
                <TableBody>
                  {filteredPaket.map((paket) => (
                    <TableRow key={paket.id.toString()}>
                      <TableCell className="font-medium">{paket.id.toString()}</TableCell>
                      ...
                      <TableCell>
                        <Badge variant="outline">{getJenisLabel(paket.jenis)}</Badge>
                      </TableCell>
                      <TableCell className="max-w-md truncate">{paket.keterangan || '-'}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
